  ...
  return (
    ...
    >
      <div className="w-full max-w-sm flex flex-col gap-8">
        ...
        <div className="text-center">
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <div className="text-left">
              <p className="text-xl font-semibold leading-none" style={{ color: 'var(--text-primary)' }}>
                invoice.plan
              </p>
        ...
        {/* Card */}
        <div className="ip-card flex flex-col gap-6">
          <div>
            <h2 className="text-lg font-semibold mb-1" style={{ color: 'var(--text-primary)' }}>
              Entrar na sua conta
            </h2>
            <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
              Use sua conta Google para acessar o invoice.plan.
            </p>
          </div>
          ...
          <button
            ...
            style={{
              background: loading ? 'var(--hover-overlay)' : 'var(--color-white)',
              color: '#1f1f1f',
